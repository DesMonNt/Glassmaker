...
namespace Shards
{
    ...
    {
        public static readonly Dictionary<string, IBuff> KeyToCrimsonBuff = new()
        {
        ...
        public static readonly Dictionary<string, IBuff> KeyToAzureBuff = new()
        {
        ...
        public static readonly Dictionary<string, IBuff> KeyToAmberBuff = new()
        {
